...
import 'package:gpayapp/Models/recharge_report_model.dart';
...
class RechargeReceipt extends StatelessWidget {
  final Datum? report;
  final ScreenshotController screenshotController = ScreenshotController();

  RechargeReceipt({Key? key, this.report}) : super(key: key);
                      ...
                      children: [
                        ...
                        TableRow(
                          children: [
                            Container(
                                padding: EdgeInsets.all(6),
                                child: boldText(
                                    'Commission', ColorResources.black111, 15)),
                            Container(
                                padding: EdgeInsets.all(6),
                                child: regularText('${report?.charge}',
                                    ColorResources.grey6B7, 14))
                          ],
                        ),
                        TableRow(
                        ...
                        TableRow(
                          children: [
                            Container(
                                padding: EdgeInsets.all(6),
                                child: boldText('Description',
                                    ColorResources.black111, 15)),
                            Container(
                                padding: EdgeInsets.all(6),
                                child: regularText('${report?.description}',
                                    ColorResources.grey6B7, 14))
                          ],
                        ),
                        TableRow(
...
void shareScreen(ScreenshotController screenshotController) async {
  try {
