...
class RechargeReport extends StatefulWidget {
  @override
  State<RechargeReport> createState() => _RechargeReport();
}

class _RechargeReport extends State<RechargeReport> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: boldText("Recharge Report", ColorResources.black, 20),
      ),
      body: Padding(
