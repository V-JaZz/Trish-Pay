...
import 'package:gpayapp/HomeScreen/Reports/payout_receipts.dart';
...
class PayoutReport extends StatefulWidget {
  @override
  State<PayoutReport> createState() => _PayoutReport();
}

class _PayoutReport extends State<PayoutReport> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: boldText("Payout Report", ColorResources.black, 20),
      ),
      body: Padding(
                      ...
                      builder: (BuildContext context,
                        ...
                        if (snapshot.hasData) {
                              ...
                              child: ListView(
                                ...
                                children:
                                  ...
                                  return ListTile(
                                      ...
                                      onTap: () {
                                        Get.to(
                                            PayoutReceipt(report: reports![i]));
                                      },
                                      leading: Container(
                                        decoration: BoxDecoration(
                                            color:
                          ...
                          return Container(
                              padding: EdgeInsets.only(bottom: Get.width / 3),
                              alignment: Alignment.center,
                              child: mediumText('${snapshot.error}',
                                  ColorResources.greyC1C, 18));
                        } else {
                          return Center(
                            child: CircularProgressIndicator(
