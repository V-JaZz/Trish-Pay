...
import '../../Models/recharge_report_model.dart';
import 'package:intl/intl.dart';
import '../../constants/constants.dart';
import 'bill_pay_receipts.dart';

class BillPayReport extends StatefulWidget {
  @override
  State<BillPayReport> createState() => _BillPayReport();
}

class _BillPayReport extends State<BillPayReport> {
  TextEditingController amount = TextEditingController();
  RechargeReportModel? model;
  List<Datum>? reports;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: boldText("Bill Pay Report", ColorResources.black, 20),
      ),
      body: Padding(
  ...
  Future<List<Datum>?> loadBillPayReport() async {
    ...
    if (response.statusCode == 200) {
      ...
      RechargeReportModel userModel = RechargeReportModel.fromJson(parsed);
      setState(() {
        model = userModel;
        reports = model?.data;
        listVisible = true;
