...
class AEPSReceipt extends StatelessWidget {
  final ScreenshotController screenshotController = ScreenshotController();
  final Datum? report;

  AEPSReceipt({Key? key, this.report}) : super(key: key);
                        ...
                        TableRow(
                          children: [
                            ...
                            Container(
                                padding: EdgeInsets.all(6),
                                alignment: Alignment.center,
                                child: regularText('${report?.aadhar}',
                        ...
                        TableRow(
                          children: [
                            Container(
                                padding: EdgeInsets.all(6),
                                child: boldText(
                                    'Remark', ColorResources.black111, 15)),
                            Container(
                                padding: EdgeInsets.all(6),
                                child: regularText('${report?.remark}',
                                    ColorResources.grey6B7, 14))
                          ],
                        ),
                        TableRow(
                          children: [
                            Container(
                                padding: EdgeInsets.all(6),
                                child: boldText(
                                    'Aeps type', ColorResources.black111, 15)),
                            Container(
                                padding: EdgeInsets.all(6),
                                child: regularText(
                                    getAepsType(report?.aepstype),
                                    ColorResources.grey6B7,
                                    14))
                          ],
                        )
